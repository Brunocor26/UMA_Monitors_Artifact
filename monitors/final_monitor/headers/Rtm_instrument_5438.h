...
#ifndef RTM_INSTRUMENT_5438_H_
#define RTM_INSTRUMENT_5438_H_

#include <writer.h>
#include <rmtld3/rmtld3.h>

#define RTM_INSTRUMENT_5438_BUFFER_SIZE 100

class RTM_INSTRUMENT_5438 {
 public:
...
class Writer_RTM_INSTRUMENT_5438 : public RTM_INSTRUMENT_5438 {
 public:
...
extern RTML_buffer<
    Event<std::underlying_type<RTM_INSTRUMENT_5438::prop_t>::type>,
    RTM_INSTRUMENT_5438_BUFFER_SIZE>
    __buffer_rtm_monitor_5438;

using Writer_rtm__5438 = Writer_RTM_INSTRUMENT_5438<
    RTML_buffer<Event<std::underlying_type<RTM_INSTRUMENT_5438::prop_t>::type>,
                RTM_INSTRUMENT_5438_BUFFER_SIZE>,
    __buffer_rtm_monitor_5438>;

#endif  // RTM_INSTRUMENT_5438_H_
