...
| Flag | Motivo |
|------|--------|
| `--target=wasm32-wasi-threads` | Usa o sysroot com suporte a threads (`wasm32-wasi-threads/`); sem isto o linker rejeita memória partilhada |
...
| `-matomics -mbulk-memory` | Features WASM necessárias para operações atómicas thread-safe |
